=== WP SEO Redirect 301 ===
Contributors: MMDeveloper, The Marketing Mix, Perth Australia
...
If you wish to manually submit a alias slug, make sure that you are using the Code Editor, not the Visual Editor. Edit the page or post, click on its 3 dots icon and click on Code Editor. Scroll down page until you see SEO Redirect 301s. Its here where you can manually enter in an alias slug.
...
1) Install WordPress 5.8.1 or higher
...
* Added CSRF protection when deleting redirect.
...
* Improved domains with custom port in domain like www.example.com:8080. Added improvement when adding alias slug to page or post.
